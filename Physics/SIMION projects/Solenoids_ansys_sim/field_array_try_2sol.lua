...
local field1 = FieldArray("SNIF4_8A_18mm_long_1mm_onlyfield.csv")
local field2 = FieldArray("SNIF-8A_18mm_long_1mm_onlyfield.csv")
...
function segment.terminate_run()
  ...
  all_results_file:write(emit_y0..","..norm_emit_y0..","..
                         ...
                         v_rms_y0..","..v_rms_z0..","..
                         v_rms_y1..","..v_rms_z1.."\n")
  all_results_file:flush()  -- immediately output to disk
